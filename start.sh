...
tmux send-keys -t 0 'clear; cd ./training; fish ../../../scripts/train.fish 1; touch /tmp/.train_done0' C-m
tmux send-keys -t 1 'clear; cd ./training; fish ../../../scripts/train.fish 2; touch /tmp/.train_done1' C-m
tmux send-keys -t 2 'clear; cd ./training; fish ../../../scripts/train.fish 3; touch /tmp/.train_done2' C-m
